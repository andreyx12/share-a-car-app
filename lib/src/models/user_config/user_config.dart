...
class UserConfig extends ErrorInfo {
  ...
  UserConfig.setError(String errorCode, String errorMessage) {
    super.errorCode = errorCode;
    super.errorMessage = errorMessage;
  }
  
  UserConfig({this.userId, this.identification, this.name, this.lastName1, this.lastName2, this.phoneNumber, this.email, this.username, this.password});

  UserConfig.fromJsonMap( Map<dynamic, dynamic> json) {
    userId                = json['id'];    
